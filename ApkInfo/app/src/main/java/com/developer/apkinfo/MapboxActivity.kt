...
class MapboxActivity : AppCompatActivity(), OnMapReadyCallback, PermissionsListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //mengambil key api mapbox  yang berisi tampilan map
    ...
    override fun onMapReady(mapboxMap: MapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_night)) { style: Style? ->
    ...
    //mengatur tampilan layar pada  geografis
    ...
    //menambahkan source geografis dengan format json
    ...
    //untuk memulai simulasi navigasi
    private fun simulasiRute(){
        btnStart.setOnClickListener { v: View? ->
            ...
            // memanggil method navigasi bersama activity
    ...
    //fungsi menampilkan icon posisi tujuan
    ...
    //fungsi mengetahui rute dari posisi sekarang sampai dengan posisi tujuan
    private fun routeMap(point: LatLng) {
        //lokasi tujuan
        val destinationPoint = Point.fromLngLat(point.longitude, point.latitude)

        //lokasi terakhir kita
        val originPoint = Point.fromLngLat(
            locationComponent!!.lastKnownLocation!!.longitude,
            locationComponent!!.lastKnownLocation!!.latitude
        )

        //menampilkaan icon lokasi tujuan
        val source = mapboxMap!!.style!!.getSourceAs<GeoJsonSource>("destination-source-id")
        source?.setGeoJson(Feature.fromGeometry(destinationPoint))

        //memanggil fungsi getroute
        getRoute(originPoint, destinationPoint)
        btnStart!!.isEnabled = true
    }

    //fungsi untuk menentukan jalur rute posisi saat ini dan tujuan
    ...
    //fungsi untuk memungkinkan location memberikan berizinan
    private fun enableLocationComponent(loadedMapStyle: Style?) {
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            // Aktivitas Komponen Lokasi MapboxMap untuk menunjukkan lokasi pengguna
            // Menambahkan di LocationComponentOptions juga merupakan parameter opsional
    ...
    //fungsi yang bisa dipanggil sekaligus dengan class secara langsung
    companion object{
